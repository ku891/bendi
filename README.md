...
- 云编译默认插件说明见本仓库 [`cloud-fix/README.md`](cloud-fix/README.md)（OpenClash、MosDNS、DDNS、SQM、KMS；不含 fileshare，可按说明自行加回）
...
```sh
bash <(curl -fsSL https://raw.githubusercontent.com/ku891/bendi/main/local.sh)
```
